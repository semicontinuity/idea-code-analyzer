...
*/
        ...
        final SimpleGraph aggregate3 = aggregate (aggregate2);
        System.out.println ("aggregate3 = " + aggregate3);

        System.out.println ("=====================================================");

        final SimpleGraph aggregate4 = aggregate (aggregate3);
        System.out.println ("aggregate4 = " + aggregate4);
*/
